...
% -------------------------------------------------------------------------
function q = applyCond(~, cond)
% The variant is now built entirely by MIDDLEEARPARAMS, which derives the
% capacitances and the added mass from physical quantities rather than
% multiplying elements by fixed factors. Just ask for it.
